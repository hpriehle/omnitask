...
@MainActor
public final class TaskStructuringService {
    private let claudeService: ClaudeService
    private let projectRepository: ProjectRepository

    public init(claudeService: ClaudeService, projectRepository: ProjectRepository) {
        self.claudeService = claudeService
        self.projectRepository = projectRepository
    }

    public struct ParsedTask: Codable, Sendable {
    ...
    public struct ParseResponse: Codable, Sendable {
        public let tasks: [ParsedTask]
    }

    public enum StructuringError: Error, LocalizedError, Sendable {
        case noAPIKey
    ...
    public func parseInput(_ input: String, defaultToToday: Bool = false, defaultProjectId: String? = nil) async throws -> [OmniTask] {
        ...
        guard hasKey else {
            ...
            let task = createSimpleTask(from: trimmed, defaultToToday: defaultToToday, defaultProjectId: defaultProjectId)
    ...
    private func parseResponse(_ response: String, originalInput: String, defaultToToday: Bool = false, defaultProjectId: String? = nil) throws -> [OmniTask] {
    ...
    private func convertToOmniTask(_ parsed: ParsedTask, sortOrder: Int, originalInput: String, defaultToToday: Bool = false, defaultProjectId: String? = nil) throws -> OmniTask {
    ...
    private func createSimpleTask(from input: String, defaultToToday: Bool = false, defaultProjectId: String? = nil) -> OmniTask {
        OmniTask(
            title: input,
            projectId: defaultProjectId,
            priority: .medium,
    ...
    public func createSubtasks(for parentId: String, titles: [String]) -> [OmniTask] {
